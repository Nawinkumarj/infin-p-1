...
export default function About() {
  ...
  useGSAP(
    ...
    { scope: sectionRef } // <- Automatically cleans up when section unmounts
  );
      ...
      <div className="home-about-container">
        <div className="home-about-top">
          ...
          <div ref={missionRef} className="home-about-mission">
            ...
            <p>
              ...
              resilient brands, and optimizing procurement strategies.
            </p>
          ...
          <div ref={promiseRef} className="home-about-promise">
            <h2>Our Vision</h2>
            <p>
              To be the leading advisory partner in project delivery, strategic
              marketing, and intelligent sourcing — enabling clients to
              transform with speed, precision, and purpose.
            </p>
            <div className="home-about-image">
        ...
        <div ref={bottomRef} className="home-about-bottom">
          ...
          <div className="home-about-right">
            <p>
              — We are a forward-thinking advisory firm helping businesses unlock
              value through precision project management, strategic marketing,
              and intelligent sourcing. With a blend of deep industry experience,
              data-driven insight, and a hands-on approach, we deliver solutions
              that not only solve today’s challenges but also prepare you for
