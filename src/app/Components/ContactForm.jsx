    ...
    <div className="contact-form-container">
      ...
      <div className="contact-left">
        ...
        <div className="contact-info-item">
          ...
          <a href="tel:+9841059274">+91 9841059274</a>
        </div>
        <div className="contact-info-item">
          <div className="icon">📧</div>
          ...
          {currentStep === 4 && (
            <div className="form-step">
              ...
              <p className="urgency-text">
                Your form has been submitted! If you need urgent help, reach out
                directly:
              </p>
              <div className="urgency-options">
                <a href="tel:+9841059274" className="urgency-btn">
          ...
          {currentStep === 5 && (
            <div className="form-step">
              <div className="thank-you">
                ...
                <p>
                  We&apos;re excited to chat. We will reach out to you soon.
                </p>
                <button
                  type="button"
                  className="btn btn-primary"
